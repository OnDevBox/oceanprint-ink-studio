        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Sobre a <span className="bg-gradient-to-r from-ocean-deep to-primary bg-clip-text text-transparent">Ocean Print</span>
            </h2>
              ...
              return (
                <Card key={index} className="text-center hover:shadow-ocean transition-all duration-300">
                  <CardContent className="p-6">
                    <div className="w-12 h-12 mx-auto mb-4 rounded-lg bg-gradient-to-br from-ocean-deep to-primary flex items-center justify-center">
                      <Icon className="h-6 w-6 text-primary-foreground" />
                    </div>
                    <div className="text-3xl font-bold mb-2 bg-gradient-to-r from-ocean-deep to-primary bg-clip-text text-transparent">
                      {stat.value}
                    </div>
